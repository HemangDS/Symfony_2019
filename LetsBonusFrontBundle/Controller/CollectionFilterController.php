...
class CollectionFilterController extends Controller
{
   ...
   /*    echo "<pre>";
       ...
       exit();*/
        $arr = array('html' => $this->render('iFlairLetsBonusFrontBundle:Collection:collection-page-ajax.html.twig', array('category_detail' => $cat_arr_filter, 'view' => $view, 'alphabet' => $request->request->get('alphabet'), 'offer' => $offer, 'addtofevlist' => $request->request->get('addtofevlist'), 'responsive_offer' => $request->request->get('offer')))->getContent());
