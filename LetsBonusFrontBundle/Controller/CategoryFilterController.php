    ...
    public function filterAction(Request $request)
    {
      ...
      /*  if (empty($request->request->get('category_id_string')) && !empty($request->request->get('alphabet'))) {
       ...
       /* // shop offer type filtering
        ...
        $arr = array('html' => $this->render('iFlairLetsBonusFrontBundle:Category:category-page-ajax.html.twig', array('category_detail' => $cat_arr_filter, 'view' => $view, 'alphabet' => $request->request->get('alphabet'), 'offer' => $offer, 'addtofevlist' => $request->request->get('addtofevlist'), 'responsive_offer' => $request->request->get('offer')))->getContent());
