...
class ContributionaddfestivalController extends Controller
{
    /**
     * @Route("/soap/v2/contributionaddfestival", name="Contribution Add Festival")
     */
    public function contributionaddfestivalAction(Request $request)
    {
        ...
        $uri = $url_model->getContributionaddfestivalURI($request);
        $location = $url_model->getContributionaddfestivalLocation($request);
        $files = $_FILES;
        ...
        try {
            ...
            $result = $client->getcontributionaddfestival($user_id,$festival_name,$country_id,$city_id,$start_date,$end_date,$feature_id,$rating_id,$music_genre,$upload_image_path);
