...
class CmsTermsandconditionsAdminController extends CRUDController
{
                    ...
                    if ($key == 'status') {
                        if ($value == 1) {
                            ...
                            if (empty($aboutus_content)) {
                                ...
                                $this->get('request')->getSession()->getFlashBag()->add('error', 'Please Keep One Terms and Conditions page Enable Only..');
