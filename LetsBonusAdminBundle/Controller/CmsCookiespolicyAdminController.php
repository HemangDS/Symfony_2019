...
class CmsCookiespolicyAdminController extends CRUDController
{
                    ...
                    if ($key == 'status') {
                        if ($value == 1) {
                            ...
                            if (empty($aboutus_content)) {
                                ...
                                $this->get('request')->getSession()->getFlashBag()->add('error', 'Please Keep One Cookies Policy page Enable Only..');
