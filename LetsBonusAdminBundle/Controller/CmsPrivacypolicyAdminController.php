...
class CmsPrivacypolicyAdminController extends CRUDController
{
                    ...
                    if ($key == 'status') {
                        if ($value == 1) {
                            ...
                            if (empty($aboutus_content)) {
                                ...
                                $this->get('request')->getSession()->getFlashBag()->add('error', 'Please Keep One Privacy Policy page Enable Only..');
